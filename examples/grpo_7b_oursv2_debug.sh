...
EXP_NAME="debug_importance_wrong_answer_perc${top_p_perception_tokens}_advsc${advantage_scaling_min}_pen${entropy_penalty_coef}_step${MAX_STEPS}_rollout${rollout}"
...
python3 -m verl.trainer.main \
    ...
    data.importance_weighting_type="information_gain" \
    data.negative_prompt_type="wrong_answer" \
    data.importance_normalization="softmax"  \
