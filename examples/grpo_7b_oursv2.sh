...
EXP_NAME="importance_wrong_answer_perc${top_p_perception_tokens}_advsc${advantage_scaling_min}_pen${entropy_penalty_coef}_step${MAX_STEPS}_rollout${rollout}"
...
python3 -m verl.trainer.main \
    ...
    data.importance_normalization="rank(20/80)"  \
